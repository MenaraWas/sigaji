    ...
    <div class="card-body">
      ...
      <form method="POST" action="<?php echo base_url('admin/Data_Tunjangan/tambahDataAksi') ?>">
        ...
        <div class="form-group">
          ...
          <input type="text" name="Jumlah_Tunjangan" class="form-control">
          <?php echo form_error('Jumlah_Tunjangan', '<div class="text-small text-danger"></div>') ?>
        </div>
        ...
        <a href="<?php echo base_url('admin/Data_Tunjangan') ?>" class="btn btn-danger">Kembali</a>
      </form>
    </div>
  </div>
</div>
