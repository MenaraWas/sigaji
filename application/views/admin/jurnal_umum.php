<div class="container-fluid">
    ...
    <button class="btn btn-sm btn-success mb-3" data-toggle="modal" data-target="#modal_tambah_jurnal"><i
...
<div class="modal fade" id="modal_tambah_jurnal" tabindex="-1" role="dialog" aria-labelledby="modal_tambah_jurnalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form id="form_tambah_jurnal" method="post"
                    action="<?php echo base_url('admin/jurnal_umum/tambah_data_aksi'); ?>">
                    <div class="form-group">
                        <label for="tanggal">Tanggal</label>
